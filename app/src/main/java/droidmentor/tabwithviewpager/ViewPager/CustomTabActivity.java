...
import droidmentor.tabwithviewpager.Fragment.ListeFragment;
import droidmentor.tabwithviewpager.Fragment.FichiersFragment;
...
public class CustomTabActivity extends AppCompatActivity {
    ...
    //Fragments
    FichiersFragment fichiersFragment;
    ListeFragment listeFragment;
    DemandeFragment demandeFragment;

    String[] tabTitle={"LISTE","DEMA.","FICHI."};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null){
            String termined = extras.getString("termined");
            if(termined.equals("ok")){
                Toast.makeText(mContext, "La demande s'est terminé avec succès", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        fichiersFragment =new FichiersFragment();
        demandeFragment =new DemandeFragment();
        adapter.addFragment(listeFragment,"Liste");
        adapter.addFragment(demandeFragment,"Demande");
        adapter.addFragment(fichiersFragment,"Fichiers");
